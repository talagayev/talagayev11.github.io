...
Here I would highlight some lessions that I learned during GSoC2024:
...
It was a fun project and I liked working on it, but the work doesn't stop here. As I mentioned there are some aspects of the code that can be improved and things that can be
